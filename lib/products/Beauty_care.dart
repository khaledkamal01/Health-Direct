...
class beauty_care extends StatefulWidget {
  ...
  static const String ScreenRoute = 'beauty_care';
  const beauty_care({super.key});
  
  
  @override
  
  State<beauty_care> createState() => _beauty_careState();
...
class _beauty_careState extends State<beauty_care> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Medicines/Beauty Care/Beauty Care").snapshots(),
            ...
            //margin: EdgeInsets.only(top: 50,left: 140,right: 90),
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 4,),
                Text(docs[index]['Name'],textAlign: TextAlign.center,),
               // Text(docs[index]['Description'],style: TextStyle(fontSize: 10),textAlign: TextAlign.center,),
