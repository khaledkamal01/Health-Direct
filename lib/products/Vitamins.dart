...
class vitamins extends StatefulWidget {
  static const String ScreenRoute = 'vitamins';
...
class _vitaminsState extends State<vitamins> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Medicines/vitamins & Healthy Nutrition/vitamins & Healthy Nutrition").snapshots(),
