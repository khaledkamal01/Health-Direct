...
class mumandbaby extends StatefulWidget {
  static const String ScreenRoute = 'mumandbaby';
  const mumandbaby({super.key});

  @override
  State<mumandbaby> createState() => _mumandbabyState();
}

class _mumandbabyState extends State<mumandbaby> {
  User? user =FirebaseAuth.instance.currentUser;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Medicines/Mum And Baby/Mum And Baby").snapshots(),
